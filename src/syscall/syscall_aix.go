...
// Constant expected by packages but not supported
const (
	_ = iota
	TIOCSCTTY
	F_DUPFD_CLOEXEC
...
// fcntl must never be called with cmd=F_DUP2FD
// However there is no way to block this behaviour without exec_unix for every fcntl
// Therefore, the programmer must called dup2 instead of fcntl in this case.
...
func Accept(fd int) (nfd int, sa Sockaddr, err error) {
	panic("Accept not yet implemented")
	return
}

func Recvmsg(fd int, p, oob []byte, flags int) (n, oobn int, recvflags int, from Sockaddr, err error) {
	panic("Recvmsg not yet implemented")
	return
}
...
func SendmsgN(fd int, p, oob []byte, to Sockaddr, flags int) (n int, err error) {
	panic("SendmsgN not yet implemented")
	return n, nil
}

func anyToSockaddr(rsa *RawSockaddrAny) (Sockaddr, error) {
	panic("anyToSockaddr not yet implemented")
}
